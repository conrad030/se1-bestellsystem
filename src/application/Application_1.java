...
//		Customer cSandra = new Customer("C12346", "Sandra Müller", "samue62@gmx.de");
//
...
//		Article aKaffemaschine = new Article("SKU-123456", "Kaffeemaschine", 2999, 500);
//		Article aTeekocher = new Article("SKU-123457", "Teekocher", 1999, 2000);
//
//		// Eric's 1st order
...
//
//		// Timo's order
//		Order o6136 = new Order(4835735356L, new Date(), cTimo);
//		o6136.addItem( // 12x Teller
//				new OrderItem(aKaffemaschine.getDescription(), aKaffemaschine, 1))
//		.addItem( // 12x Teller
//				new OrderItem(aTasse.getDescription(), aTasse, 6));
//
//		// Sandra's order
//		Order o6137 = new Order(6399437335L, new Date(), cSandra);
//		o6137.addItem( // 12x Teller
...
//			
//			String orderString = "#" + orders.get(orderIndex).getId() + ", " + orders.get(orderIndex).getCustomer().getFirstName() + "'s Bestellung: ";
//			long fullPrice = 0;
//			
//			for (int itemIndex = 0; itemIndex < orders.get(orderIndex).getItems().size(); itemIndex++) {
//				orderString += orders.get(orderIndex).getItems().get(itemIndex).getUnitsOrdered() + "x " + orders.get(orderIndex).getItems().get(itemIndex).getDesciption();
//				if (itemIndex != orders.get(orderIndex).getItems().size() - 1) {
//					orderString += ", ";
//				}
//				
//				fullPrice += orders.get(orderIndex).getItems().get(itemIndex).getArticle().getUnitPrice() * orders.get(orderIndex).getItems().get(itemIndex).getUnitsOrdered();
//			}
//			priceTotal += fullPrice;
//			
//			String fmtFullPrice = fmtPrice(fullPrice, "EUR");
//			sbLineItem = fmtLine(orderString, fmtFullPrice, printLineWidth);
//			
//			sbAllOrders.append("\n");
